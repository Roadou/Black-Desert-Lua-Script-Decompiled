...
function PaGlobal_TutorialPhase_BasicSkill_Giant:startPhaseXXX(stepNo, typeNo)
  ...
  _PA_LOG("\237\138\156\237\134\160\235\166\172\236\150\188", "PaGlobal_TutorialPhase_BasicSkill_Giant:startStep() typeNo : " .. tostring(typeNo))
...
function PaGlobal_TutorialPhase_BasicSkill_Giant:changeStepTryBasicSkill()
  ...
  elseif 3 == self._currentProgress then
    ...
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(self._currentProgress, PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_05"), PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_06"))
  elseif 4 == self._currentProgress then
    ...
    PaGlobal_TutorialUiManager:getUiBlackSpirit():setSpiritUiForTutorial_Title(PAGetString(Defines.StringSheet_GAME, "TUTORIAL_PURPOSE_BATTLE_STEP7") .. " ( " .. self._usedSkillCount .. " / " .. self._totalSkillCount .. " )")
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(self._currentProgress, PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Giant_0_Combo_1"), PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Giant_0_ComboKey_1"))
  end
end
...
function PaGlobal_TutorialPhase_BasicSkill_Giant:changeStepTrySkillCombo()
  ...
  PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(1, PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_GIANT_COMBO_0_2"), PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_GIANT_COMMAND_0_2"))
end
...
function PaGlobal_TutorialPhase_BasicSkill_Giant:eventCallUsedSkill_TrySkillCombo(skillWrapper)
  ...
  for key, value in pairs(self._skillNoList[listNo]) do
    if skillNo == value then
      ...
      PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(2, PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_GIANT_COMBO_1_3"), PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_35"))
