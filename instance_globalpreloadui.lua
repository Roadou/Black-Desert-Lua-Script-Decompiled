local _voidCursor = UI.getChildControl(Instance_Cursor, "Static_Cursor")
local _consoleCursor = UI.getChildControl(Instance_Cursor, "Static_ConsoleCursor")
Instance_Cursor:SetShow(true)
...
Instance_Cursor:RegisterUpdateFunc("CursorUIEffect_UpdateCursorPos")
