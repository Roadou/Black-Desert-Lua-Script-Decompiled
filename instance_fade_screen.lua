Instance_Fade_Screen:SetPosX(0)
Instance_Fade_Screen:SetPosY(0)
Instance_Fade_Screen:SetShow(false, false)
Instance_Fade_Screen:SetSize(getScreenSizeX(), getScreenSizeY())
Instance_Fade_Screen:SetIgnore(true)
local lua_StaticText_FieldName = UI.getChildControl(Instance_Fade_Screen, "StaticText_FieldName")
...
function startFadeIn(strFieldName)
  Instance_Fade_Screen:SetShow(true, false)
  Instance_Fade_Screen:SetColor(UI_color.C_FFFFFFFF)
  if strFieldName ~= nil then
    ...
    local aniInfoFadeOut = Instance_Fade_Screen:addColorAnimation(6, 8, UI_ANI_ADV.PAUI_ANIM_ADVANCE_COS_HALF_PI)
    aniInfoFadeOut:SetStartColor(UI_color.C_FFFFFFFF)
    aniInfoFadeOut:SetEndColor(0)
  else
    lua_StaticText_FieldName:SetShow(false)
    local aniInfoFadeOut = Instance_Fade_Screen:addColorAnimation(1, 4, UI_ANI_ADV.PAUI_ANIM_ADVANCE_COS_HALF_PI)
    aniInfoFadeOut:SetStartColor(UI_color.C_FFFFFFFF)
    aniInfoFadeOut:SetEndColor(0)
  end
end
