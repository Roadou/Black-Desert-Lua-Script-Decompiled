    ...
    if self._uiButtonInviteVolunteer:GetShow() then
      ...
      if true == _ContentsGroup_BattleFieldVolunteer and (true == isGuildMaster or true == isGuildSubMaster) then
        ...
        if self._uiButtonInviteVolunteer:GetSizeX() - 10 < self._uiButtonInviteVolunteer:GetTextSizeX() then
          self._uiButtonInviteVolunteer:SetTextMode(UI_TM.eTextMode_AutoWrap)
...
function ChatUIPoolManager:createPool(poolIndex, poolStylePanel, poolParentPanel)
  ...
  function ChatUIPool:initialize(stylePanel, parentControl, poolIndex)
    ...
    ChatUIPool:prepareControl(stylePanel, self._list_PanelBG[0], self._list_ChattingIcon, UI_PUCT.PA_UI_CONTROL_STATICTEXT, "Static_ChatIcon", self._maxcount_ChattingIcon)
    ChatUIPool:prepareControl(stylePanel, self._list_PanelBG[0], self._list_ChattingSender, UI_PUCT.PA_UI_CONTROL_STATICTEXT, "StaticText_ChatSender", self._maxcount_ChattingSender)
    ChatUIPool:prepareControl(stylePanel, self._list_PanelBG[0], self._list_ChattingContents, UI_PUCT.PA_UI_CONTROL_STATICTEXT, "StaticText_ChatContent", self._maxcount_ChattingContents)
    ChatUIPool:prepareControl(stylePanel, self._list_PanelBG[0], self._list_ChattingLinkedItem, UI_PUCT.PA_UI_CONTROL_STATICTEXT, "StaticText_ChatLinkedItem", self._maxcount_ChattingLinkedItem)
    ChatUIPool:prepareControl(stylePanel, self._list_PanelBG[0], self._list_ChattingLinkedGuild, UI_PUCT.PA_UI_CONTROL_STATICTEXT, "StaticText_ChatLinkedGuild", self._maxcount_ChattingLinkedGuild)
    ChatUIPool:prepareControl(stylePanel, self._list_PanelBG[0], self._list_ChattingGuildMark, UI_PUCT.PA_UI_CONTROL_STATIC, "Static_GuildMark", self._maxcount_ChattingGuildMark)
    ChatUIPool:prepareControl(stylePanel, self._list_PanelBG[0], self._list_ChattingLinkedWebSite, UI_PUCT.PA_UI_CONTROL_STATICTEXT, "StaticText_ChatLinkedWebSite", self._maxcount_ChattingLinkedWebSite)
    ...
    ChatUIPool:prepareControl(stylePanel, self._list_PanelBG[0], self._list_Emoticon, UI_PUCT.PA_UI_CONTROL_STATIC, "Static_Emoticon", self._maxcount_Emoticon)
    ChatUIPool:prepareControl(stylePanel, self._list_PanelBG[0], self._list_ChatEmoticon, UI_PUCT.PA_UI_CONTROL_STATIC, "Static_ChatEmoticon", self._maxcount_ChatEmoticon)
    ChatUIPool:prepareControl(stylePanel, self._list_PanelBG[0], self._list_At, UI_PUCT.PA_UI_CONTROL_STATICTEXT, "Static_At", self._maxcount_At)
    ChatUIPool:prepareControl(stylePanel, self._list_PanelBG[0], self._list_EmoticonAni, UI_PUCT.PA_UI_CONTROL_STATIC, "Static_ChatEmoticon_SequenceAni", self._maxcount_EmoticonAni)
