...
function PaGlobal_TutorialPhase_BasicSkill_Combattant:changeStepTryBasicSkill()
  ...
  elseif 3 == self._currentProgress then
    ...
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(self._currentProgress, PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIALXB_COMBATTANT_SKILLNAME_1"), PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIALXB_COMBATTANT_SKILLCOMMAND_1"))
  elseif 4 == self._currentProgress then
    ...
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setTextPurposeText(PAGetString(Defines.StringSheet_GAME, "TUTORIAL_PURPOSE_BATTLE_STEP7") .. " ( " .. self._usedSkillCount .. " / " .. self._totalSkillCount .. " )")
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(self._currentProgress, PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_STRIKER_COMBO_0_3"), PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_STRIKER_COMMAND_0_3"))
  end
end
...
function PaGlobal_TutorialPhase_BasicSkill_Combattant:changeStepTrySkillCombo()
  ...
  PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(1, PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIALXB_COMBATTANT_SKILLNAME_2"), PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIALXB_COMBATTANT_SKILLCOMMAND_2"))
end
...
function PaGlobal_TutorialPhase_BasicSkill_Combattant:eventCallUsedSkill_TrySkillCombo(skillWrapper)
  ...
  for key, value in pairs(self._skillNoList[listNo]) do
    if skillNo == value then
      ...
      PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(2, PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIALXB_COMBATTANT_SKILLNAME_3"), PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIALXB_COMBATTANT_SKILLCOMMAND_3"))
