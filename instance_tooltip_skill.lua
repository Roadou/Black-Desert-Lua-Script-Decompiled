...
local ToolTipSkillUI = {
  ...
  skill_Movie = UI.createControl(CppEnums.PA_UI_CONTROL_TYPE.PA_UI_CONTROL_WEBCONTROL, Instance_Tooltip_Skill, "WebControl_Skill_Movie"),
...
local ToolTipSkillUI_learning = {
  ...
  skill_Movie = UI.createControl(CppEnums.PA_UI_CONTROL_TYPE.PA_UI_CONTROL_WEBCONTROL, Instance_Tooltip_Skill_forLearning, "WebControl_Skill_Movie")
}
local ToolTipSkillUI_blackSpirit = {
  ...
  skill_Movie = UI.createControl(CppEnums.PA_UI_CONTROL_TYPE.PA_UI_CONTROL_WEBCONTROL, Instance_Tooltip_Skill_forBlackSpirit, "WebControl_Skill_Movie")
}
