...
function inven:createSlot()
  for ii = 0, self.config.slotCount - 1 do
    local slot = {}
    slot.empty = UI.createControl(CppEnums.PA_UI_CONTROL_TYPE.PA_UI_CONTROL_STATIC, Instance_Window_Inventory, "Inventory_Slot_Base_" .. ii)
    slot.lock = UI.createControl(CppEnums.PA_UI_CONTROL_TYPE.PA_UI_CONTROL_STATIC, Instance_Window_Inventory, "Inventory_Slot_Lock_" .. ii)
    slot.plus = UI.createControl(CppEnums.PA_UI_CONTROL_TYPE.PA_UI_CONTROL_STATIC, Instance_Window_Inventory, "Inventory_Slot_Plus_" .. ii)
    slot.onlyPlus = UI.createControl(CppEnums.PA_UI_CONTROL_TYPE.PA_UI_CONTROL_STATIC, Instance_Window_Inventory, "Inventory_Slot_OnlyPlus_" .. ii)
  ...
  for ii = 0, self.config.slotCount - 1 do
    ...
    slot.background = UI.createControl(UI_PUCT.PA_UI_CONTROL_STATIC, Instance_Window_Inventory, "Inventory_Slot_BG_" .. ii)
  ...
  if isEquip then
    ...
    if nil ~= equipItemWrapper then
      ...
      elseif enum_class.ClassType_Lahn == classType and (67 == equipType or 70 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
        ...
        equipOffencePoint = (ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMinDamage(0) + ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMaxDamage(0)) / 2
        matchEquip = true
      elseif 1 == classType and (1 == equipType or 8 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
        offencePoint = (itemWrapper:getStaticStatus():getMinDamage(0) + itemWrapper:getStaticStatus():getMaxDamage(0)) / 2
        equipOffencePoint = (ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMinDamage(0) + ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMaxDamage(0)) / 2
        defencePoint = itemWrapper:getStaticStatus():getDefence(0)
        matchEquip = true
      elseif 3 == classType and (1 == equipType or 8 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
        offencePoint = (itemWrapper:getStaticStatus():getMinDamage(0) + itemWrapper:getStaticStatus():getMaxDamage(0)) / 2
        equipOffencePoint = (ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMinDamage(0) + ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMaxDamage(0)) / 2
        defencePoint = itemWrapper:getStaticStatus():getDefence(0)
        matchEquip = true
      elseif 9 == classType and (28 == equipType or 33 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
        offencePoint = (itemWrapper:getStaticStatus():getMinDamage(2) + itemWrapper:getStaticStatus():getMaxDamage(2)) / 2
        equipOffencePoint = (ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMinDamage(2) + ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMaxDamage(2)) / 2
        matchEquip = true
      elseif 10 == classType and (28 == equipType or 33 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
        offencePoint = (itemWrapper:getStaticStatus():getMinDamage(2) + itemWrapper:getStaticStatus():getMaxDamage(2)) / 2
        equipOffencePoint = (ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMinDamage(2) + ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMaxDamage(2)) / 2
        matchEquip = true
      elseif 13 == classType and (29 == equipType or 34 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
        offencePoint = (itemWrapper:getStaticStatus():getMinDamage(0) + itemWrapper:getStaticStatus():getMaxDamage(0)) / 2
        equipOffencePoint = (ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMinDamage(0) + ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMaxDamage(0)) / 2
        matchEquip = true
      elseif 15 == classType and (29 == equipType or 34 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
        offencePoint = (itemWrapper:getStaticStatus():getMinDamage(0) + itemWrapper:getStaticStatus():getMaxDamage(0)) / 2
        equipOffencePoint = (ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMinDamage(0) + ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMaxDamage(0)) / 2
        matchEquip = true
      elseif 6 == classType and (3 == equipType or 36 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
        offencePoint = (itemWrapper:getStaticStatus():getMinDamage(0) + itemWrapper:getStaticStatus():getMaxDamage(0)) / 2
        equipOffencePoint = (ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMinDamage(0) + ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMaxDamage(0)) / 2
        matchEquip = true
      elseif 7 == classType and (3 == equipType or 36 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
        offencePoint = (itemWrapper:getStaticStatus():getMinDamage(0) + itemWrapper:getStaticStatus():getMaxDamage(0)) / 2
        equipOffencePoint = (ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMinDamage(0) + ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMaxDamage(0)) / 2
        matchEquip = true
      elseif 30 == classType and (2 == equipType or 56 == equipType or 55 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
        offencePoint = (itemWrapper:getStaticStatus():getMinDamage(0) + itemWrapper:getStaticStatus():getMaxDamage(0)) / 2
        equipOffencePoint = (ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMinDamage(0) + ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMaxDamage(0)) / 2
        matchEquip = true
      end
