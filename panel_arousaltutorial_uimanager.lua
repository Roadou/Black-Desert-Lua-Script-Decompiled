...
function PaGlobal_ArousalTutorial_UiManager:getUiBlackSpirit()
  return self._uiList._uiBlackSpirit
end
function PaGlobal_ArousalTutorial_UiManager:getUiKeyButton()
  return self._uiList._uiKeyButton
end
function PaGlobal_ArousalTutorial_UiManager:getUiHeadlineMessage()
  return self._uiList._uiHeadlineMessage
end
function PaGlobal_ArousalTutorial_UiManager:getUiMasking()
  return self._uiList._uiMasking
end
function FromClient_luaLoadComplete_ArousalTutorial_UiManager()
  PaGlobal_ArousalTutorial_UiManager:initialize()
end
function PaGlobal_ArousalTutorial_UiManager:initialize()
  ...
  _PA_LOG("\234\179\189\235\175\188\236\154\176", "PaGlobal_ArousalTutorial_UiManager:initialize() UI \235\167\164\235\139\136\236\160\128 \236\180\136\234\184\176\237\153\148 \236\153\132\235\163\140!")
end
function FGlobal_ArousalTutorial_UiManager_ShowAni()
  PaGlobal_ArousalTutorial_UiManager:showAni()
end
function FGlobal_ArousalTutorial_UiManager_HideAni()
  PaGlobal_ArousalTutorial_UiManager:hideAni()
end
function PaGlobal_ArousalTutorial_UiManager:showAni()
...
function PaGlobal_ArousalTutorial_UiManager:hideAni()
  PaGlobal_ArousalTutorial_UiManager:getUiBlackSpirit():changeBubbleTextureForAni(false)
  Panel_ArousalTutorial:ResetVertexAni()
...
function PaGlobal_ArousalTutorial_UiManager:hideAllTutorialUi()
...
function FromClient_ArousalTutorial_ScreenReposition()
  PaGlobal_ArousalTutorial_UiManager:repositionScreen()
end
function PaGlobal_ArousalTutorial_UiManager:repositionScreen()
