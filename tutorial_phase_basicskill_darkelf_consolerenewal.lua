...
function PaGlobal_TutorialPhase_BasicSkill_DarkElf:changeStepTryBasicSkill()
  ...
  elseif 4 == self._currentProgress then
    ...
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setTextPurposeText(PAGetString(Defines.StringSheet_GAME, "TUTORIAL_PURPOSE_BATTLE_STEP7") .. " ( " .. self._usedSkillCount .. " / " .. self._totalSkillCount .. " )")
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(self._currentProgress, PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIALXBL_DARKKNIGHT_SKILLNAME_1"), PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIALXB_DARKKNIGHT_SKILLCOMMAND_1"))
  end
end
...
function PaGlobal_TutorialPhase_BasicSkill_DarkElf:changeStepTrySkillCombo()
  ...
  PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(1, PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIALXB_DARKKNIGHT_SKILLNAME_2"), PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIALXB_DARKKNIGHT_SKILLCOMMAND_2"))
end
