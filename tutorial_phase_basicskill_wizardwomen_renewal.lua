...
function PaGlobal_TutorialPhase_BasicSkill_WizardWomen:startPhaseXXX(stepNo, typeNo)
  ...
  _PA_LOG("\237\138\156\237\134\160\235\166\172\236\150\188", "PaGlobal_TutorialPhase_BasicSkill_WizardWomen:startStep() typeNo : " .. tostring(typeNo))
...
function PaGlobal_TutorialPhase_BasicSkill_WizardWomen:changeStepTryBasicSkill()
  ...
  elseif 3 == self._currentProgress then
    ...
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(self._currentProgress, PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_30"), PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_31"))
  elseif 4 == self._currentProgress then
    ...
    PaGlobal_TutorialUiManager:getUiBlackSpirit():setSpiritUiForTutorial_Title(PAGetString(Defines.StringSheet_GAME, "TUTORIAL_PURPOSE_BATTLE_STEP7") .. " ( " .. self._usedSkillCount .. " / " .. self._totalSkillCount .. " )")
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(self._currentProgress, PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_WIZARD_COMBO_0_2"), PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_32"))
  end
end
...
function PaGlobal_TutorialPhase_BasicSkill_WizardWomen:changeStepTrySkillCombo()
  ...
  PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(1, PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_33"), PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_34"))
end
...
function PaGlobal_TutorialPhase_BasicSkill_WizardWomen:eventCallUsedSkill_TrySkillCombo(skillWrapper)
  ...
  for key, value in pairs(self._skillNoList[listNo]) do
    if skillNo == value then
      ...
      PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(2, PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_WIZARD_COMBO_1_3"), PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_WIZARD_COMMAND_1_3"))
