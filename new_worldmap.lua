...
function FGlobal_WorldMapWindowEscape()
  ...
  if ToClient_WorldMapIsShow() then
    ...
    if _panel_houseControl:GetShow() == false and Panel_LargeCraft_WorkManager:GetShow() == false and Panel_RentHouse_WorkManager:GetShow() == false and Panel_Building_WorkManager:GetShow() == false and Panel_House_SellBuy_Condition:GetShow() == false and PaGlobalFunc_PanelDelivery_GetShow() == false and Panel_Trade_Market_Graph_Window:GetShow() == false and (_panel_TradeMarket_EventInfo:GetShow() == false or _panel_TradeMarket_EventInfo:IsUISubApp() == true) and Worldmap_Grand_GuildHouseControl:GetShow() == false and Worldmap_Grand_GuildCraft:GetShow() == false and Panel_NodeStable:GetShow() == false and Panel_Window_Warehouse:GetShow() == false and (Panel_CheckedQuest:GetShow() == false or Panel_CheckedQuest:IsUISubApp() == true) and Panel_Window_Delivery_InformationView:GetShow() == false and (PaGlobalFunc_ItemMarket_GetShow() == false or PaGlobalFunc_ItemMarket_IsUISubApp() == true) and (true == _ContentsGroup_NewUI_WorkerManager_All and false == Panel_Window_WorkerManager_All:GetShow() or false == _ContentsGroup_NewUI_WorkerManager_All and false == Panel_WorkerManager:GetShow()) and Panel_WorldMap_MovieGuide:GetShow() == false and (true == _ContentsGroup_NewUI_WorkerManager_All or false == _ContentsGroup_NewUI_WorkerManager_All and false == Panel_WorkerTrade:GetShow() and (true == _ContentsGroup_NewUI_WorkerManager_All or false == _ContentsGroup_NewUI_WorkerManager_All and false == Panel_WorkerTrade_Caravan:GetShow())) then
      ToClient_WorldMapPushEscape()
    end
    if true == _ContentsGroup_NewDelivery and nil ~= PaGlobal_InformationView and true == Panel_Window_Delivery_Information:GetShow() then
