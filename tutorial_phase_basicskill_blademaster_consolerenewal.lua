...
function PaGlobal_TutorialPhase_BasicSkill_BladeMaster:changeStepTryBasicSkill()
  ...
  elseif 3 == self._currentProgress then
    ...
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(self._currentProgress, PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_BLADEMASTER_COMBO_1_3"), PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_WARRIOR_COMMAND_1_1"))
  elseif 4 == self._currentProgress then
    ...
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setTextPurposeText(PAGetString(Defines.StringSheet_GAME, "TUTORIAL_PURPOSE_BATTLE_STEP7") .. " ( " .. self._usedSkillCount .. " / " .. self._totalSkillCount .. " )")
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(self._currentProgress, PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIALXB_BLADEMASTER_SKILLNAME_1"), PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIALXB_BLADEMASTER_SKILLCOMMAND_1"))
  end
end
...
function PaGlobal_TutorialPhase_BasicSkill_BladeMaster:changeStepTrySkillCombo()
  ...
  PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(1, PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIALXB_BLADEMASTER_SKILLNAME_2"), PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIALXB_BLADEMASTER_SKILLCOMMAND_2"))
end
...
function PaGlobal_TutorialPhase_BasicSkill_BladeMaster:eventCallUsedSkill_TrySkillCombo(skillWrapper)
  ...
  for key, value in pairs(self._skillNoList[listNo]) do
    if skillNo == value then
      ...
      PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(2, PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_BLADEMASTER_COMBO_0_3"), PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_BLADEMASTER_COMMAND_0_3"))
