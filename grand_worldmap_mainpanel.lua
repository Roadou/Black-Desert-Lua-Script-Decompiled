...
local function MakeModeChekcState()
  ...
  worldMapCheckState[eCheckState.eCheck_MyBossMonster] = UI.createControl(CppEnums.PA_UI_CONTROL_TYPE.PA_UI_CONTROL_CHECKBUTTON, Panel_WorldMap_Main, "CheckButton_MyBossMonster")
  if true == _ContentsGroup_Barter then
    worldMapCheckState[eCheckState.eCheck_Barter] = UI.createControl(CppEnums.PA_UI_CONTROL_TYPE.PA_UI_CONTROL_CHECKBUTTON, Panel_WorldMap_Main, "CheckButton_Barter")
  end
